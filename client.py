...
class UJIClient(fl.client.Client):
    ...
    def __init__(
        ...
        trainset,testset: utils.load_data() #torch.utils.data.DataLoader,
#         _,testset: utils.load_data() #torch.utils.data.DataLoader,
    ) -> None:
        self.cid = cid
        self.model = model
...
def main() -> None:
    ...
    # Start client
    client = UJIClient(args.cid, model, trainset, testset)
